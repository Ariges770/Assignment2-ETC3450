...
For the ADF test: The $\tau$ statistic was given as $`r hm_adf_testval`$, which is greater than the critical value of $`r hm_adf_cval`$ at the $5\%$ significance level. Thus, we fail to reject $H_0$ and conclude that the series may have a unit root and differencing is necessary.
